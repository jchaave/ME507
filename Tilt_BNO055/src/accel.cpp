/** @file accel.cpp
 *    This file contains source code for the function that read the information
 *    from the IMU as well as print the data found.
 * 
...
Accelerometer::Accelerometer(uint16_t x_dir_acel, uint16_t threshold)
{
    Pin = pin;
    ThreshOLD = threshold;
